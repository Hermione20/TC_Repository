...
#define USART2_Data_Receive_Process				do{printf("0x30");}while(0) 
#define USART3_Data_Receive_Process				do{printf("0x30");}while(0) 
#define USART4_Data_Receive_Process				do{printf("0x30");}while(0); 
#define USART5_Data_Receive_Process				do{printf("0x30");}while(0); 
